...
$UDCLIENT -weburl $UCD_SERVER_URL -username $USERNAME -password $PASSWORD createResource $UPDATE_RESOURCE >> $LOG_FILE

$UDCLIENT -weburl $UCD_SERVER_URL -username $USERNAME -password $PASSWORD createResource  $MAP_COMPONENT >> $LOG_FILE
